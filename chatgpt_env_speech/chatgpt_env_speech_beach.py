...
for index in tqdm(range(0, 5)):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            },
            {
                ...
                "Now, let's firstly fcous on a special background noise types: sea beach. \n"
                ...
                "Again, the scene we are focusing on is an adult conversation but the reply may change due to the presence of sea beach. \n"
    ...
    with open(
        "temp_jsons/gpt_env_examples_txt/beach_{}.txt".format(str(index)), "w"
    ) as f:
        f.write(response)
    ...
    # save the response to a file
    with open("temp_jsons/gpt_env_examples/beach_{}.json".format(str(index)), "w") as f:
